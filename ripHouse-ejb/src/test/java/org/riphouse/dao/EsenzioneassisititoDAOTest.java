...
/**
 * JUnit tests for EsenzioneassisititoDAO
 * 
 * @author Telosys Tools
 *
 */
public class EsenzioneassisititoDAOTest {
	...
	public void testDAO() throws SQLException {
    	...
    	EsenzioneassisititoDAO dao = DAOProvider.getDAO(EsenzioneassisititoDAO.class);
		...
		esenzioneassisitito.setAssisitito(1000L); // "Assisitito" : java.lang.Long
    	...
    	Esenzioneassisitito esenzioneassisitito2 = dao.find(pkAutoIncr);
		...
		esenzioneassisitito2.setAssisitito(2000L); // "Assisitito" : java.lang.Long
    	System.out.println("Update : " + esenzioneassisitito2 );
    	Assert.assertTrue( dao.update(esenzioneassisitito2) == 1 );
    	
    	//--- LOAD
    	Esenzioneassisitito esenzioneassisitito3 = new Esenzioneassisitito();
		...
		Assert.assertEquals(esenzioneassisitito2.getAssisitito(), esenzioneassisitito3.getAssisitito() ); 

...
public class DAOProvider {
	...
	public final static String DAO_IMPLEMENTATION_FULL_PACKAGE_NAME = "org.riphouse.dao.impl.jdbc" ; // e.g. "org.demo.dao.impl.jdbc" ;
	...
	private final static String buildDAOClassName(Class<?> interfaceClass) {
		...
		if ( DAO_IMPLEMENTATION_CLASS_SUFFIX != null ) {
			implemSimpleName = interfaceSimpleName + DAO_IMPLEMENTATION_CLASS_SUFFIX.trim() ;
		}
		...
		if ( DAO_IMPLEMENTATION_FULL_PACKAGE_NAME != null ) {
			String p = DAO_IMPLEMENTATION_FULL_PACKAGE_NAME.trim() ;
			return p + "." + implemSimpleName ;
		}
		else if ( DAO_IMPLEMENTATION_SUB_PACKAGE_NAME != null ) {
			String p = DAO_IMPLEMENTATION_SUB_PACKAGE_NAME.trim() ;
